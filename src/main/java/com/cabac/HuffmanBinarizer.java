...
public class HuffmanBinarizer implements Binarizer {
    ...
    public HuffmanBinarizer(int[] alphabet, int[] frequencies) {
    ...
    public String name() {
        return "Huffman(m=" + alphabet.length + ")";
    }
    ...
    public void encode(int[] data, ArithmeticEncoder enc) throws IOException {
        ...
        for (int v : data) {
            ...
            for (int b : code) enc.encodeBin(ctx, b);
        }
    }
    ...
    public int[] decode(ArithmeticDecoder dec, int count) throws IOException {
        ...
        while (produced < count) {
            ...
            if (cur.length() > maxLen) {
                throw new IOException("Huffman decode overflow");
            }
        }
        return result;
    }
